...
<script src = "/js/updateForm.js"></script>
    ...
    <form action="adminUpdate" method="post" name = "adminUpdate" enctype="multipart/form-data">
        <fieldset>
            <legend>회원 정보 수정</legend>
            <input type="hidden" name="m_no" value="${adminUpdate.m_no}">
            <input type="hidden" name="m_authority" value="${adminUpdate.m_authority}">
            <input type="hidden" name="m_image" value="${adminUpdate.m_image}">
            <table>
                <tr>
                    <td>아이디</td>
                    <td>${update.m_id}</td>
                ...
                <tr>
                    <td>이름</td>
                    <td><input type="text" name="m_name" value="${adminUpdate.m_name}"></td>
                </tr>
				<tr>
					<td>비밀번호</td>
                ...
                <tr>
                    <td>닉네임</td>
                    <td><input type="text" name="m_nickname" value="${adminUpdate.m_nickname}"></td>
                </tr>
                <tr>
					<td>배송주소</td>
					<td>
				...
				<tr>
                    <td>생년월일</td>
                    <td><input type="text" name="m_bir" value="${adminUpdate.m_bir}"></td>
                </tr>
                <tr>
                    <td>이메일</td>
                    <td><input type="text" name="m_email" value="${adminUpdate.m_email}"></td>
                </tr>
				<tr>
					<td>전화번호</td>
					<td>
				...
				<tr>
                    <td>프로필 이미지</td>
                    <td>새 파일 : <input type="file" name="m_image_file" class="form-control"> <br>기존파일 : ${adminUpdate.m_image}</td>
                </tr>
            </table>
        </fieldset>
